...
const englishBase = {
  ...
  // About
  aboutTitle: 'About Ultra Wash Laundry', aboutDescription: 'Your trusted partner for premium laundry and dry cleaning services since 2010.', ourMission: 'Our Mission', ourVision: 'Our Vision', qualityFirst: 'Quality First', qualityDesc: 'We never compromise on quality. Every garment receives premium care.', customerFocused: 'Customer Focused', customerDesc: 'Your satisfaction is our priority. We listen, adapt, and deliver.', ecoFriendly: 'Eco-Friendly', ecoDesc: 'We use environmentally safe products and sustainable practices.', innovation: 'Innovation', innovationDesc: 'We embrace cutting-edge technology to provide superior service.',
  
  // Features
  features: 'Features', whyChooseUs: 'Why Choose Us', experienceTitle: 'Experience the Ultra Wash Difference', experienceDesc: 'Join thousands of satisfied customers who trust us with their garment care.',
