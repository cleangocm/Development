            ...
            <div className="space-y-1.5">
              ...
              <div className={`relative transition-all duration-300 ${validationErrors.password && touched.password ? 'animate-shake' : ''}`}>
                ...
                <input
                  ...
                  onBlur={handleBlur}
                  placeholder="••••••••"
                  className={`w-full pl-10 sm:pl-12 pr-12 py-3 sm:py-3.5 border rounded-lg sm:rounded-xl text-sm sm:text-base text-[#0f2744] dark:text-white bg-white dark:bg-gray-700 placeholder-gray-400 focus:outline-none transition-all duration-300 ${
