        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-8 sm:mb-12 animate-fade-in-up">
            <div className="relative w-full max-w-md mx-auto">
              <div className="text-[120px] sm:text-[180px] md:text-[220px] font-bold text-transparent bg-clip-text bg-linear-to-br from-[#0F2744] to-[#00BFA6] leading-none">
                404
              </div>
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-24 h-24 sm:w-32 sm:h-32 bg-[#00BFA6]/10 rounded-full animate-pulse"></div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-8 sm:mb-12 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
            <div className="flex justify-center gap-4 text-gray-400 dark:text-gray-500">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center">
          ...
          <div className="mt-8 sm:mt-12 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
            <button
              ...
              className="inline-flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-[#0F2744] dark:hover:text-white font-medium transition-colors"
            >
          ...
          {/* Help Text */}
          <div className="mt-12 sm:mt-16 pt-8 sm:pt-12 border-t border-gray-200 dark:border-gray-700 animate-fade-in-up" style={{ animationDelay: '500ms' }}>
            <p className="text-sm sm:text-base text-gray-500 dark:text-gray-400 mb-4">
              Need help? Here are some useful links:
            </p>
            <div className="flex flex-wrap justify-center gap-4 sm:gap-6 text-sm sm:text-base">
              <Link href="/about" className="text-[#00BFA6] hover:text-[#00A892] hover:underline transition-colors">
                About Us
              </Link>
              <Link href="/contact" className="text-[#00BFA6] hover:text-[#00A892] hover:underline transition-colors">
                Contact Support
              </Link>
              <Link href="/blog" className="text-[#00BFA6] hover:text-[#00A892] hover:underline transition-colors">
                Blog
              </Link>
              <Link href="/cart" className="text-[#00BFA6] hover:text-[#00A892] hover:underline transition-colors">
                View Cart
              </Link>
            </div>
          </div>
