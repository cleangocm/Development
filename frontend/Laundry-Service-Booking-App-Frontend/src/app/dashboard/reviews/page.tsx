                ...
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <FiPackage className="w-4 h-4 text-[#00BFA6]" />
                  ...
                  <div className="flex items-center gap-2">
                    {review.status === 'approved' ? (
                      ...
                      <button
                        ...
                        className="flex items-center gap-1.5 px-4 py-2 bg-[#00BFA6] text-white text-sm font-medium rounded-lg hover:bg-[#00A892] transition-colors"
                      >
        ...
        <>
          ...
          <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-9999 w-[90vw] max-w-md animate-scale-in">
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-2xl">
              ...
              <textarea
                value={newComment}
                onChange={e => setNewComment(filterSafeText(e.target.value))}
                placeholder="Share your experience (optional)..."
                rows={4}
                className="w-full px-4 py-3 border border-gray-200 dark:border-gray-600 rounded-lg outline-none focus:ring-2 focus:ring-[#00BFA6]/30 focus:border-[#00BFA6] bg-white dark:bg-gray-700 text-gray-900 dark:text-white resize-none text-sm"
              />
              ...
              <div className="flex gap-3 mt-5">
                ...
                <button
                  ...
                  className="flex-1 px-6 py-2.5 bg-[#00BFA6] text-white rounded-lg font-medium hover:bg-[#00A892] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {submitting ? (
