    ...
    try {
      ...
      if (navigator.clipboard && navigator.clipboard.writeText) {
        ...
        try {
          ...
          showToast('Copy failed. Please copy manually: ' + cleanCode, 'warning');
        }
        textArea.remove();
      }
    } catch (err) {
      // Show user a prompt to copy manually
      showToast('Please copy this code manually: ' + cleanCode, 'info');
    }
  };
              ...
              <div
                ...
                className={`relative border rounded-xl overflow-hidden transition-shadow hover:shadow-md ${
                  inactive
                    ...
                    : 'border-[#00BFA6]/30 dark:border-[#00BFA6]/20'
                }`}
              >
                <div className="flex flex-col sm:flex-row">
                  ...
                  <div className={`shrink-0 w-full sm:w-32 p-4 flex flex-col items-center justify-center text-center ${
                    inactive
                      ...
                      : 'bg-linear-to-br from-[#00BFA6]/10 to-[#0F2744]/10 dark:from-[#00BFA6]/20 dark:to-[#0F2744]/20'
                  }`}>
                    <FiPercent className={`w-6 h-6 mb-1 ${
                      inactive ? 'text-gray-400' : 'text-[#00BFA6]'
                    }`} />
                    <span className={`text-2xl font-bold ${
                      inactive ? 'text-gray-400 dark:text-gray-500' : 'text-[#0F2744] dark:text-[#00BFA6]'
                    }`}>
                    ...
                    <div className="flex items-center gap-2">
                      <div className={`flex items-center gap-2 px-3 py-1.5 rounded-lg border-2 border-dashed ${
                        inactive
                          ...
                          : 'border-[#00BFA6]/50 bg-[#00BFA6]/5 dark:bg-[#00BFA6]/10'
                      }`}>
                        <code className={`text-sm font-mono font-bold tracking-wider ${
                          inactive ? 'text-gray-400' : 'text-[#0F2744] dark:text-[#00BFA6]'
                        }`}>
                          {coupon.code}
                        </code>
                      </div>
                      {!inactive && (
                        <button
                          ...
                          className="flex items-center gap-1 px-3 py-1.5 text-xs font-medium text-[#00BFA6] hover:bg-[#00BFA6]/10 rounded-lg transition-colors"
                        >
