...
const SignupPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!hasErrors) {
      ...
      try {
        ...
        // useEffect will handle redirect based on user role
      } catch (error: unknown) {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      {/* Right Side - Form */}
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6 md:p-8 lg:p-12 bg-white dark:bg-gray-900 min-h-screen lg:min-h-0 overflow-y-auto">
        <div className="w-full max-w-100 sm:max-w-105 py-6 sm:py-8 animate-fade-in-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
            ...
            <div className="space-y-1">
              ...
              <div className={`relative transition-all duration-300 ${errors.fullName && touched.fullName ? 'animate-shake' : ''}`}>
                ...
                <input
                  ...
                  className={`w-full pl-10 sm:pl-12 pr-4 py-2.5 sm:py-3 border rounded-lg sm:rounded-xl text-sm sm:text-base text-[#0f2744] dark:text-white bg-white dark:bg-gray-800 placeholder-gray-400 focus:outline-none transition-all duration-300 ${
            ...
            {/* Email Input */}
            <div className="space-y-1">
              <label className="block text-xs sm:text-sm font-medium text-[#0f2744] dark:text-gray-200">Email</label>
            ...
            {/* Password Input */}
            <div className="space-y-1">
              <label className="block text-xs sm:text-sm font-medium text-[#0f2744] dark:text-gray-200">Create Password</label>
              <div className={`relative transition-all duration-300 ${errors.password && touched.password ? 'animate-shake' : ''}`}>
                ...
                <input
                  ...
                  onBlur={handleBlur}
                  placeholder="••••••••"
                  className={`w-full pl-10 sm:pl-12 pr-12 py-2.5 sm:py-3 border rounded-lg sm:rounded-xl text-sm sm:text-base text-[#0f2744] dark:text-white bg-white dark:bg-gray-800 placeholder-gray-400 focus:outline-none transition-all duration-300 ${
                    ...
                    {[...Array(5)].map((_, i) => (
                      <div
                        ...
                        className={`h-1 flex-1 rounded-full transition-all duration-300 ${
                          i < getPasswordStrength() ? strengthColors[getPasswordStrength() - 1] : 'bg-gray-200 dark:bg-gray-700'
                        }`}
                      />
                    ))}
                  </div>
                  <p className={`text-xs ${strengthTextColors[getPasswordStrength() - 1] || 'text-gray-400'}`}>
            ...
            <div className="space-y-1">
              <label className="block text-xs sm:text-sm font-medium text-[#0f2744] dark:text-gray-200">Confirm Password</label>
            ...
            <button
              ...
              className="w-full bg-[#00BFA6] text-white py-3 sm:py-3.5 rounded-lg sm:rounded-xl font-semibold text-sm sm:text-base transition-all duration-300 hover:bg-[#00A892] hover:shadow-lg disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-2"
            >
